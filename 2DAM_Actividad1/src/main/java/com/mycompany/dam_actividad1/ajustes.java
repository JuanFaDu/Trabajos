...
public class ajustes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Español", "Francés", "Inglés", "Italiano" }));

        jLabel3.setText("Modo daltónico");

        jButton2.setText("Desactivado");
